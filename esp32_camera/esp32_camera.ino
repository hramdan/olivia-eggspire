...
void loop()
{
  ...
  if (ei_sleep(5) != EI_IMPULSE_OK) {
    ...
    // Print predictions (from your original code)
    ...
    // Send prediction to another ESP32
    if (client.connect(serverAddress, serverPort)) {
        String prediction = "";
        // Assuming first label is "good" and second is "bad"
        ...
        client.stop();
        Serial.println("Prediction sent: " + prediction);
    } else {
...
// All your original camera functions remain the same below
bool ei_camera_init(void) {
